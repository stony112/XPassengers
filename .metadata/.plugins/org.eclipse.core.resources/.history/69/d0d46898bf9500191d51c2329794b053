...
<form method="post" action="/EditAircraftServlet">
	...
	<div class="xp_seatconfig">
		<div class="xp_sliderWrapper">
			...
			<input name="sliderFirst" type="range" min="0" max="<%= seats %>" value="<%= aircraft.getInt("first") %>" class="xp_slider" id="xp_sliderFirst"/>
			<span id="xp_sliderFirstValue" class="xp_sliderValue"></span>
		</div>
		<div class="xp_sliderWrapper">
			<label for="sliderBusiness" class="xp_sliderLabel">Business</label>
			<input name="sliderBusiness" type="range" min="0" max="<%= seats) %>" value="<%= aircraft.getInt("business") %>" class="xp_slider" id="xp_sliderBusiness"/>
			<span id="xp_sliderBusinessValue" class="xp_sliderValue"></span>
		</div>
		<div class="xp_sliderWrapper">
			<label for="sliderEconomy" class="xp_sliderLabel">Economy</label>
			<input type="range" min="0" max="<%= seats %>" value="<%= aircraft.getInt("economy") %>" class="xp_slider" id="xp_sliderEconomy"/>
