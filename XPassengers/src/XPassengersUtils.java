...
public class XPassengersUtils {
	...
	public int getActiveAirline() {
		int id = Integer.parseInt(XPassengers.ini.get("airlines","activeAirline"));		
		return id;
	}
	...
	public int checkNewPlanes() throws FileNotFoundException, ClassNotFoundException, SQLException {
		databaseAccess dao = new databaseAccess();
		dao.initDB();
		String airplanePath;
		String airplaneName;
		...
		float price;
		int eng = 0, prop = 0;
		String xplanePath = XPassengers.ini.get("options","xplanePath");
